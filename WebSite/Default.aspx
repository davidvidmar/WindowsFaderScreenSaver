...
<head runat="server">
    ...
    <title>Windows Fader Screensaver</title>
...
<!--    <form id="form1" runat="server"> -->
    ...
    <div id="header">
        ...
        <div id="menu">
            <p>
                <img src="images/monitor_128.png" width="128" height="128" alt="Windows Fader Logo" />
            </p>
        </div>
    </div>
    <!-- end header -->
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="http://vidmar.net/weblog/">My Blog </a>&nbsp;(<a href="http://feeds.vidmar.net/BiteMyBytes">RSS
                            Feed</a>)</li>
                        <li><a href="http://vidmar.net/weblog/category/28.aspx">Windows Fader News</a> (<a
                            href="http://feeds.feedburner.com/WindowsFader">RSS Feed</a>)</li>
                        <li><a href="http://vidmar.net/weblog/contact.aspx">Contact Form</a></li>
                        <li><a href="http://www.addtoany.com/share_save?linkname=Windows%20Fader&amp;linkurl=http%3A%2F%2Fwindowsfader.com">
                            <img alt="Share/Save/Bookmark" border="0" height="16" src="http://static.addtoany.com/buttons/share_save_171_16.gif"
...
<!-- /PayPal Donate -->
            ...
            <div class="info">
                ...
                <p>
                    <i>Using screen saver when using LCD monitor will not help save energy. </i>
                </p>
                <p>
                    <i>Flat screen monitors use same amount of energy no matter how bright or dark the screen
                        is. You should turn your monitor off is you really want to save energy! </i>
                </p>
            </div>
        </div>
        <!-- end sidebar -->
...
<!--    </form> --->
    ...
    <script type="text/javascript">
        var pageTracker = _gat._getTracker("UA-6417826-1");
